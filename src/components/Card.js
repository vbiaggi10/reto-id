  ...
  render() {
    return (
      <div className="Card-container">
        <img className="Card-photo" src={this.state.photo} />
        ...
        <div className="Card-icons-container" onClick={() => { this.setState({ openInfo: !this.state.openInfo }) }}>
          ...
          {this.state.openInfo ? <img onClick={() => { this.moreInfo(true) }} src={bookmarkIcon} className="Search-icon" alt="bookmark" /> : null}
        </div>
      </div>
    );
  }
